...
public class SupabaseRepository {
    ...
    @Nullable
    private File extractGlb(@NonNull File zipFile, @NonNull File outputDir) throws IOException {
        try (ZipInputStream zipInputStream = new ZipInputStream(new java.io.FileInputStream(zipFile))) {
            ...
            while ((entry = zipInputStream.getNextEntry()) != null) {
                ...
                File outputFile = new File(outputDir, "model.glb");
